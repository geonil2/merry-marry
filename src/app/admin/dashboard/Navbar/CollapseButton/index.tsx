...
const CollapseButton = ({ onToggleCollapse, collapseClick }: Props) => {
  console.log(collapseClick);
  return (
    <button
      className="relative inline-flex justify-center items-center flex-[0_0_auto] p-2 cursor-pointer"
      onClick={onToggleCollapse}
    >
      <div
        className={`leading-[0px] transition-all ${
          collapseClick && `rotate-180`
        }`}
      >
        {icon}
      </div>
